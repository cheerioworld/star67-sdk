...
namespace Star67.Sdk
{
    ...
    /// </summary>
    // public class BasisAvatarFaceBlendshapeDriver : IAvatarFaceBlendshapeDriver
    // {
    ...
    //     public BasisAvatarFaceBlendshapeDriver(SkinnedMeshRenderer[] faceMeshes)
    //     {
    ...
    //     public void Apply(FaceBlendshape[] frame)
    //     {
    //         if (!_isMapBuilt)
    //         {
